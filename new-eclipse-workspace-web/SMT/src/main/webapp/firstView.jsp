...
<head>
    ...
    <body>
        <h1 class="visually-hidden">요긴 로그인 쓸모는 없습니다</h1>
        ...
        <!-- <c:if test="${sessionScope.memberID!=null}"> -->
            <div class="px-4 py-5 my-5 text-center">
                ...
                <h1 class="display-5 fw-bold">${sessionScope.memberID} 환영합니다!</h1>
                <div class="col-lg-6 mx-auto">
                    <p class="lead mb-4">게시판에 글을 남기고 댓글을 남겨주세요!
                        <br> 해당 게시판에 관한 내용은 GitHub를 통해 확인할 수 있습니다.
                    </p>
                    <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                        <button type="button" class="btn btn-primary btn-lg px-4 gap-3" onclick="changeFirstView(2)">게시판 바로가기</button>
                        <button type="button" class="btn btn-outline-secondary btn-lg px-4" onclick="changeFirstView(3)">깃허브 바로가기</button>
                    </div>
                </div>
            </div>
        <!-- </c:if>  -->  
